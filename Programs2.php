...
.mk-header {
	border-bottom: 1px solid rgba(237, 237, 237, 0.01);
}
...
@font-face {
	...
	src: url('wp-content/themes/jupiter/assets/stylesheet/fonts/star/font.eot?#iefix') format('embedded-opentype'), url('wp-content/themes/jupiter/assets/stylesheet/fonts/star/font.woff') format('woff'), url('wp-content/themes/jupiter/assets/stylesheet/fonts/star/font.ttf') format('truetype'), url('wp-content/themes/jupiter/assets/stylesheet/fonts/star/font.svg') format('svg');
	font-weight: normal;
	font-style: normal;
}
...
@font-face {
	...
	src: url('wp-content/themes/jupiter/assets/stylesheet/fonts/woocommerce/font.eot?#iefix') format('embedded-opentype'), url('wp-content/themes/jupiter/assets/stylesheet/fonts/woocommerce/font.woff') format('woff'), url('wp-content/themes/jupiter/assets/stylesheet/fonts/woocommerce/font.ttf') format('truetype'), url('wp-content/themes/jupiter/assets/stylesheet/fonts/woocommerce/font.svg') format('svg');
	font-weight: normal;
	font-style: normal;
}
...
#mk-imagebox-3 .item-holder,
#mk-imagebox-3 .swiper-navigation {
	margin: 0 10px;
}

#imagebox-item-4 .item-wrapper {
	background-color: #2d6ca1;
}

#imagebox-item-4 .item-title h5 {
	color: #ffffff;
	font-weight: bold;
	font-size: 30px;
}

#imagebox-item-4 .item-content,
#imagebox-item-4 .item-content p {
	color: #ffffff;
}

#imagebox-item-4 .item-button a {
	background-color: #1b96b1;
	color: #ffffff;
}

#imagebox-item-4 .item-button a:hover {
	background-color: #54e0ff;
}

#imagebox-item-5 .item-wrapper {
	background-color: #2d6ca1;
}

#imagebox-item-5 .item-title h5 {
	color: #ffffff;
	font-weight: bold;
	font-size: 30px;
}

#imagebox-item-5 .item-content,
#imagebox-item-5 .item-content p {
	color: #ffffff;
}

#imagebox-item-5 .item-button a {
	background-color: #1b96b1;
	color: #ffffff;
}

#imagebox-item-5 .item-button a:hover {
	background-color: #54e0ff;
}

#imagebox-item-6 .item-wrapper {
	background-color: #2d6ca1;
}

#imagebox-item-6 .item-title h5 {
	color: #ffffff;
	font-weight: bold;
	font-size: 30px;
}

#imagebox-item-6 .item-content,
#imagebox-item-6 .item-content p {
	color: #ffffff;
}

#imagebox-item-6 .item-button a {
	background-color: #1b96b1;
	color: #ffffff;
}

#imagebox-item-6 .item-button a:hover {
	background-color: #54e0ff;
}         
      </style>
         ...
         <div id="mk-theme-container" >
            <header data-height='70'
               ...
               <section id="mk-page-introduce" class="intro-left">
                  ...
                  <div class="mk-grid">
                     <h1 class="page-title" style="color:#2d6ca1;" >CEES Academy Programs</h1>
                                          ...
                                          <div class="item-holder">
                                             <div class="item-wrapper">
                                                ...
                                                <div class="item-title">
                                                   <h5>Lean Sigma Belt Certification</h5>
                                                </div>
                                       ...
                                       <div id="imagebox-item-5" class="mk-imagebox-item  image-type">
                                          <div class="item-holder">
                                             <div class="item-wrapper">
                                                ...
                                                <div class="item-title">
                                                   <h5>Kaizen Simulation Workshops</h5>
                                                </div>
                                                <div class="item-content">
                                                   <span>
                                                      <p>Simulation based training serious which gives participants an opportunity to realize critical points in implementing kaizens.</p>
                                                   </span>
                                                </div>
                                                <div class="item-button">
                                       ...
                                       <div id="imagebox-item-6" class="mk-imagebox-item  image-type">
                                          <div class="item-holder">
                                             <div class="item-wrapper">
                                                ...
                                                <div class="item-title">
                                                   <h5>Specialized Training Modules</h5>
                                                </div>
                                                <div class="item-content">
                                                   <span>
                                                      <p>Focused specialized training series which drives tangible business results in 4 -6 months</p>
                                                   </span>
                                                </div>
                                                <div class="item-button">
                                                   <a href="index.html">LEARN MORE</a>
			...
			<section id="title1" class="intro-left">
                  <div class="mk-grid">
                     <h1 class="page-title" style="color:#2d6ca1;" >CEES Academy Programs</h1>
                     <div class="clearboth"></div>
                  </div>
